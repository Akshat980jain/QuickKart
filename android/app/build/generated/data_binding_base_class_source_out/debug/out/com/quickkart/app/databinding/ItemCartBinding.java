...
public final class ItemCartBinding implements ViewBinding {
  ...
  private ItemCartBinding(@NonNull MaterialCardView rootView, @NonNull ImageButton decreaseButton,
      @NonNull ImageButton increaseButton, @NonNull TextView itemTotal,
      ...
      @NonNull ImageButton removeButton, @NonNull TextView stockStatus) {
  ...
  public static ItemCartBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemCartBinding((MaterialCardView) rootView, decreaseButton, increaseButton,
          itemTotal, productCategory, productImage, productName, productPrice, quantityText,
          removeButton, stockStatus);
    }
